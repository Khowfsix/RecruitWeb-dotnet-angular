...
namespace Data.Migrations
{
    ...
    [Migration("20240410161716_renamePropIn_Application")]
    partial class renamePropIn_Application
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Data.Entities.Award", b =>
                {
                    ...
                    b.Property<DateTime>("IssueDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 10, 23, 17, 16, 571, DateTimeKind.Local).AddTicks(9279));
            ...
            modelBuilder.Entity("Data.Entities.Certificate", b =>
                {
                    ...
                    b.Property<DateTime>("IssueDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 10, 23, 17, 16, 565, DateTimeKind.Local).AddTicks(1490));
            ...
            modelBuilder.Entity("Data.Entities.Education", b =>
                {
                    ...
                    b.Property<DateTime>("From")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 10, 23, 17, 16, 571, DateTimeKind.Local).AddTicks(2788));
            ...
            modelBuilder.Entity("Data.Entities.PersonalProject", b =>
                {
                    ...
                    b.Property<DateTime?>("From")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 10, 23, 17, 16, 571, DateTimeKind.Local).AddTicks(7769));
            ...
            modelBuilder.Entity("Data.Entities.WebUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "dd9f234d-f9ca-41a7-b19a-f0811b3a8f2c",
                            AccessFailedCount = 0,
                        ...
                        new
                        {
                            Id = "f6e047ce-95c1-4201-bf34-8b35e2de83c2",
                            AccessFailedCount = 0,
            ...
            modelBuilder.Entity("Data.Entities.WorkExperience", b =>
                {
                    ...
                    b.Property<DateTime?>("From")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 10, 23, 17, 16, 571, DateTimeKind.Local).AddTicks(4301));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "41a75301-08ed-45ff-962e-1ead14267faf",
                            ConcurrencyStamp = "1",
                            Name = "Candidate",
                        ...
                        new
                        {
                            Id = "06d6d68a-5fbb-4eb3-a615-25d96a936a64",
                            ConcurrencyStamp = "2",
                            Name = "Interviewer",
                        ...
                        new
                        {
                            Id = "b1d529f8-0199-48f5-bc1f-a0f8b580dbbb",
                            ConcurrencyStamp = "3",
                            Name = "Recruiter",
                        ...
                        new
                        {
                            Id = "94a81e0b-50d6-43ed-be82-8c4bd7f8bf86",
                            ConcurrencyStamp = "4",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "dd9f234d-f9ca-41a7-b19a-f0811b3a8f2c",
                            RoleId = "41a75301-08ed-45ff-962e-1ead14267faf"
                        },
                        new
                        {
                            UserId = "dd9f234d-f9ca-41a7-b19a-f0811b3a8f2c",
                            RoleId = "b1d529f8-0199-48f5-bc1f-a0f8b580dbbb"
                        },
                        new
                        {
                            UserId = "f6e047ce-95c1-4201-bf34-8b35e2de83c2",
                            RoleId = "94a81e0b-50d6-43ed-be82-8c4bd7f8bf86"
                        },
                        new
                        {
                            UserId = "f6e047ce-95c1-4201-bf34-8b35e2de83c2",
                        ...
                        {
                            UserId = "f6e047ce-95c1-4201-bf34-8b35e2de83c2",
                            RoleId = "06d6d68a-5fbb-4eb3-a615-25d96a936a64"
                        },
                        new
                        {
                            UserId = "f6e047ce-95c1-4201-bf34-8b35e2de83c2",
            ...
            modelBuilder.Entity("Data.Entities.Interview", b =>
                {
                    ...
                    b.HasOne("Data.Entities.Itrsinterview", "Itrsinterview")
                        .WithMany("Interviews")
