...
public partial class RecruitmentWebContext : IdentityDbContext<WebUser>
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
         ...
         => optionsBuilder.UseSqlServer("Data Source=DESKTOP-LNGKOTN\\DEVELOPER;Initial Catalog=RecruitmentWeb;Integrated Security=True;Trust Server Certificate=True");
